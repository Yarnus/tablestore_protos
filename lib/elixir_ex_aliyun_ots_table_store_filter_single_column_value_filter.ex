  ...
  (
    ...
    (
      (
        ...
        def(encode!(msg)) do
          ...
          |> encode_value_transfer_rule(msg)
        end
      )
      ...
      [
        ...
        defp(encode_value_transfer_rule(acc, msg)) do
          try do
            case(msg.value_transfer_rule) do
              nil ->
                acc

              _ ->
                [acc, "2", Protox.Encode.encode_message(msg.value_transfer_rule)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:value_transfer_rule, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
          ...
          {new_set_fields, field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {6, _, bytes} ->
                ...
                {[:value_transfer_rule | set_fields],
                 [
                   value_transfer_rule:
                     Protox.MergeMessage.merge(
                       msg.value_transfer_rule,
    ...
    def(defs()) do
      %{
        ...
        6 =>
          {:value_transfer_rule, {:scalar, nil},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          __struct__: Protox.Field,
          json_name: "valueTransferRule",
          kind: {:scalar, nil},
          label: :optional,
          name: :value_transfer_rule,
          tag: 6,
    ...
    [
      ...
      (
        def(field_def(:value_transfer_rule)) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "valueTransferRule",
        ...
        def(field_def("valueTransferRule")) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "valueTransferRule",
    ...
    [
      ...
      def(default(:value_transfer_rule)) do
        {:ok, nil}
      end,
      def(default(_)) do
        {:error, :no_such_field}
